...
import pro.sky.telegrambot.component.NotificationTaskCreator;
import pro.sky.telegrambot.component.NotificationTasksSender;
    ...
    public int process(List<Update> updates) {
        try {
            updates.forEach(update -> {
                ...
                String welcomeAnswer = "Hello! Создавайте напоминания отправив сообщения в формате - дд.мм.гг вв:мм текст напоминания";
                if (("/start").equals(messageText)) {
                    ...
                    if (matcher.find() && (dateTime = parse(matcher.group(1))) != null) {
                        ...
                        sender.sendMessage(chatId, "напоминание сохранено");
                    } else {
                        sender.sendMessage(chatId, "некорректный ввод данных");
                    }
                }
            });
        } catch (Exception e) {
